...
import { Container, ThemeProvider, display } from '@mui/system';
import { createTheme } from '@mui/material/styles';
import { Table, TableBody, TableRow, LinearProgress, TableHead, TableContainer, TextField, Typography, TableCell, Pagination } from '@mui/material';
...
const CoinsTable = () => {
    ...
    const fetCoins = async () => {
        ...
        try {
            ...
            const apiUrl = CoinList(currency);
